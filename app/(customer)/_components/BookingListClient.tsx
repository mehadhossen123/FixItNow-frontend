          ...
          {bookings.map((item) => (
            ...
            >
              ...
              <div className="px-5 py-3 bg-gray-50/50 border-t border-gray-100 flex items-center justify-between text-xs text-gray-400">
                ...
                <Link href={`/dashboard/get-all-booking/${item?.id}`} className="inline-flex items-center gap-1 text-blue-600 group-hover:text-green-700 font-semibold transition-all group-hover:translate-x-1">
