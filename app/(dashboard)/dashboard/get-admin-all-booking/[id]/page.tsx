...
const SingleBookingPageForAdmin = async ({ params }: PageProps) => {
  const { id } = await params;
  const allBookings = await getAllBookingByAdmin();
  ...
  if (!booking) {
    return (
      <div className="max-w-4xl mx-auto px-4 py-16 text-center">
        ...
        <Link
          href="/dashboard/get-admin-all-booking"
...
export default SingleBookingPageForAdmin;
