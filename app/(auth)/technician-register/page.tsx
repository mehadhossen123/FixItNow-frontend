...
import TechnicianRegisterForm from "../_components/TechnicianRegisterForm";
  ...
  return (
    <div className="w-full min-h-screen bg-[#7B8B9E] flex justify-center items-center p-4 sm:p-6">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl p-6 sm:p-8">
        ...
        <div className="flex flex-col items-center text-center mb-6">
          <div className="mb-2">
            ...
            <div className="flex gap-2 items-center">
              <div><img src="/logo.jpeg" width={70} height={70} alt="" /></div>
              <div>
        ...
        {/* ফরম */}
        <TechnicianRegisterForm></TechnicianRegisterForm>
